"""
Django settings for yhl_django project.
...
SECRET_KEY = 'django-insecure-uhe*zg2fr=%_bqvhcs_k3(ml&n_d#of%rp$sha(4tu+#zl5#_j'
...
WSGI_APPLICATION = 'yhl_django.wsgi.application'
